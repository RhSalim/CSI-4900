...
#Save the cleaned temperature data as Excel
temp_data_cleaned.to_excel('Cleaned_Temperature_Data.xlsx',index = False)

#Save the normalized coordinate data as Excel
coord_data_normalized.to_excel('Normalized_Coordinate_Data.xlsx',index = False)

#Save the cleaned temperature data as CSV
temp_data_cleaned.to_csv('Cleaned_Temperature_Data.csv',index = False)

#Save the normalized coordinate data as CSV
coord_data_normalized.to_csv('Normalized_Coordinate_Data.csv',index = False)
